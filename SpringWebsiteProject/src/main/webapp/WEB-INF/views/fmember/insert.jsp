<%@page import="kr.mail.fmember.MailSend"%>
...
<link rel="stylesheet" href="/resources/css/fmember/insert.css">
				...
				<div class="address_wrap">
					...
					<div class="address_input_1_wrap">
						<div class="address_input_1_box">
							<input class="address_input_1" name="memAd1" readonly="readonly">
						</div>
					...
					<div class="address_input_2_wrap">
						<div class="address_input_2_box">
							<input class="address_input_2" name="memAd2" readonly="readonly"">
						</div>
					</div>
					<div class="address_input_3_wrap">
						<div class="address_input_3_box">
							<input class="address_input_3" name="memAd3" readonly="readonly">
						</div>
					</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".join_button").click(function() {
	            ...
	            $("#join_form").attr("action", "/fmember/insert");
	            $("#join_form").submit(); 
				}
		        return false;
			});
